...
%% almost as usual
\author{Andreas Alfons\\K.U.Leuven \And Matthias Templ\\Vienna University of\\Technology,\\Statistics Austria \And Peter Filzmoser\\Vienna University of\\Technology}
...
\Address{
  ...
  Naamsestraat 69\\
  3000 Leuven, Belgium\\
  E-mail: \email{andreas.alfons@econ.kuleuven.be}\\
  URL: \url{http://www.econ.kuleuven.be/andreas.alfons/public/}
}
